...
$landing_slug = 'cargador';
$landing_token = obtenerOCrearTokenLanding($landing_slug, 'Cargador iphone 2', 232000);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Cargador iphone 2 - Oferta Especial</title>
...
<body>
    ...
    <div class="image-container">
        ...
        <div class="hero-section">
            <img src="desktop.png" alt="Cargador iphone 2 Desktop" class="img-desktop">
            <img src="mobile.png" alt="Cargador iphone 2 Mobile" class="img-mobile">
        ...
        <div class="info-section" id="infoContainer">
            <img src="desktop2.png" alt="Cargador iphone 2 Info PC" class="img-desktop">
            <img src="mobile2.png" alt="Cargador iphone 2 Info Mobile" class="img-mobile">
            <div class="video-wrapper" id="wrap1">
                <div id="vid1" data-id="a"></div>
            </div>
            <div class="video-wrapper" id="wrap2">
                <div id="vid2" data-id="a"></div>
            </div>
            <div class="video-wrapper" id="wrap3">
                <div id="vid3" data-id="a"></div>
            </div>
        </div>
            ...
            <div class="gallery-wrapper">
                ...
                <div class="mobile-video-gallery" id="mobileGallery">
                    <div class="gallery-item">
                        <iframe loading="lazy" src="https://www.youtube.com/embed/a?controls=1&modestbranding=1&rel=0&playsinline=1" allow="encrypted-media" allowfullscreen></iframe>
                    </div>
                    <div class="gallery-item">
                        <iframe loading="lazy" src="https://www.youtube.com/embed/a?controls=1&modestbranding=1&rel=0&playsinline=1" allow="encrypted-media" allowfullscreen></iframe>
                    </div>
