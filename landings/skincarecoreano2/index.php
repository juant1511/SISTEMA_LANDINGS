...
$landing_slug = 'skincarecoreano2';
$landing_token = obtenerOCrearTokenLanding($landing_slug, 'Beauty of joseon relief sunrice probiotics', 27800);
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        .btn-link {
            ...
            top: 49.52%; left: 3.69%; width: 25.7%; height: 7.4%;
        }
        @keyframes pulse {
        ...
        @media (max-width: 768px) {
            ...
            .btn-link { top: 64.15%; left: 0.00%; width: 100%; height: 11.7%; }
