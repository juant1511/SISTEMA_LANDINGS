<?php
/**
 * config.php generado por SISTEMA TRIDENTE Builder v5.0.0
 * Landing: logitech-g-pro-x2-superstrike
 */
if (!defined('LANDING_SLUG'))      define('LANDING_SLUG', 'logitech-g-pro-x2-superstrike');
if (!defined('LANDING_TOKEN'))     define('LANDING_TOKEN', '35fa348dd87249a49dd7b9ed28d6ca9f');
if (!defined('PRODUCTO_NOMBRE'))   define('PRODUCTO_NOMBRE', 'Logitech G PRO X2 SUPERSTRIKE');
if (!defined('PRODUCTO_PRECIO'))   define('PRODUCTO_PRECIO', 249060);
