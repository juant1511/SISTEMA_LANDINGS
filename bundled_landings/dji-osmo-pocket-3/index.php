...
<body class="<?= $es_modo_edicion ? 'modo-edicion-activo' : '' ?>" style="<?= $es_modo_edicion ? 'margin-top: 50px;' : '' ?>">
    ...
    <div class="category-switcher">
        <a href="#cat1" class="category-pill active" data-editable="true">CÁMARAS & GIMBALS</a>
        <a href="#cat2" class="category-pill inactive" data-editable="true">DRONES & ACCESORIOS</a>
    </div>
    ...
    <script>
        ...
        const LANDING_TOKEN = "f1d1838550ee35b801d95c0d95d7118a";
        ...
        let cartState = { qty: 1, variant: "Creator Combo", size: "Kit Completo 6 en 1" };
